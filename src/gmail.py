...
class gmail:
    ...
    def __init__(self, master):
        ...
        self.send = Button(frame5, text='Send', width=5, bg='#ffe6e6',
                           relief=FLAT, command=lambda: self.mail()).place(x=0, y=20)
        self.formating = Button(frame5, text='A', width=5,
                                bg='#ffe6e6', relief=FLAT).place(x=60, y=20)
        self.Attach = Button(frame5, text='B', width=5, bg='#ffe6e6',
                             relief=FLAT, command=lambda: self.attach()).place(x=120, y=20)
        self.insertLink = Button(
            frame5, text='C', bg='#ffe6e6', width=5, relief=FLAT).place(x=180, y=20)
        self.insertEmoji = Button(
            frame5, text='D', bg='#ffe6e6', width=5, relief=FLAT).place(x=240, y=20)
        self.insertfile = Button(
            frame5, text='E', bg='#ffe6e6', width=5, relief=FLAT).place(x=280, y=20)
        self.insertPhoto = Button(
            frame5, text='F', bg='#ffe6e6', width=5, relief=FLAT).place(x=320, y=20)
        self.delete = Button(frame5, text='G', width=5,
                             bg='#ffe6e6', relief=FLAT).place(x=360, y=20)
    ...
    def mail(self):
        ...
        p.add_header('Content-Disposition',
                     "attachment; filename= %s" % self.attachment)
        msg.attach(p)
