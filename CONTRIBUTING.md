# Contributing to Instamail

Thank you for showing your interest in contributing to Instamail! From commenting on and triaging issues, to reviewing and sending Pull Requests, all contributions are welcome.

This document covers everything you need to know about contributing to Instamail. Before you get started, please make sure you read all of the sections and are able to sign our CLA.
...
Powflix has adopted "Contributor Covenant Code of Conduct V2.0", participants are expected to follow the guildlines described in [CODE_OF_CONDUCT](https://github.com/powflix/instamail/blob/master/CODE_OF_CONDUCT.md)
...
Code-level contributions to Instamail generally come in the form of pull requests. These are done by forking the repo and making changes locally. The process of proposing a change to Instamail can be summarized as follows:

* Fork the Instamail repository and create your branch from `master`.
* Make the desired changes to Instamail sources and perform tests.
* If you've added code that should be tested, add tests.
* Ensure the test suite passes, either locally or on CI once you opened a pull request.
* Push the changes to your fork.
* Create a pull request to the Instamail repository.
...
Contributions to Instamail is not limited to GitHub. You can help others by sharing your experience using Instamail, whether that is through blog posts, presenting talks at conferences, or simply sharing your thoughts on Twitter and tagging @Powflix

## Coding guidelines

Please see [CODING_CONVENTIONS_STANDARDS](https://github.com/powflix/instamail/blob/master/docs/CODING_CONVENTIONS_STANDARDS.md) in `/docs` repository for good practices of Coding Styles.

## Good Pull Request

Please see [PR_GUIDELINES](https://github.com/powflix/instamail/blob/master/docs/PR_GUIDELINES.md) in `/docs` repository for good practices of Pull Requests.
